...
//file name for save task
define("TASKS_FILE", "tasks.json");

//load task for first time & every reload
...
//task save to task.json file
function saveTasks(array $tasks) : void {
    file_put_contents(TASKS_FILE, json_encode($tasks, JSON_PRETTY_PRINT));
}

//handel form submit for add task, delete task and toggle complete task
